...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s1 = new Seller(1, "Bob Brow", "bobdev@gmail.com", new DateTime(1998, 4, 21), 1800.0, d1);
            Seller s2 = new Seller(1, "Maria Greeg", "mariasellers@gmail.com", new DateTime(1995, 2, 14), 1900.0, d2);
            Seller s3 = new Seller(1, "Alex ASfas", "alex@gmail.com", new DateTime(1992, 7, 2), 2450.0, d3);
            Seller s4 = new Seller(1, "Marta Reds", "martar@gmail.com", new DateTime(1999, 2, 5), 1800.0, d4);
            Seller s5 = new Seller(1, "Donad Ssssso", "donad@gmail.com", new DateTime(1993, 4, 1), 1400.0, d2);
            Seller s6 = new Seller(1, "Jizu Flederic", "jizuu@gmail.com", new DateTime(1997, 5, 12), 1800.0, d1);
